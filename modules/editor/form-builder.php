	...
	public static function parse_html( $code ) {
		...
		if ( empty( $code ) || ! isset( $code ) ) {
			...
			if ( $startingNode === null ) {
				return new WP_Error( 'FORM_BUILD_FAILED', 'Something went wrong importing your form. A <code>&lt;form&gt;</code> tag was not found in the imported HTML. This means your form is incomplete in Keap.' );
			}
